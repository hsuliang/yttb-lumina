...
import {
    analyzeWavPcm, normalizeLanguageCode, parseWhisperDictionary,
    processWhisperResult, formatWhisperResult,
} from '../public/js/whisper-processing.js';

// 版本規則：每次發布程式變更時版號前進一版，例如 1.3.0 → 1.3.2。
const WORKER_VERSION = '1.3.2';
    ...
    try {
        ...
        async function transcribeAttempt(retry = false) {
            ...
            return processWhisperResult(result, {
                language, promptWords, replaceRules, audioAnalysis, isFirstChunk, usedMinimalInput,
            });
        }
...
export { buildWhisperInput };
export * from '../public/js/whisper-processing.js';
