...
export const VariationHub = (function() {
    ...
    const DEFAULT_STYLES = {
        ...
        thumbnail: [
            { name: '隨機驚喜', value: '' },
            { name: '情緒張力加倍', value: '請進一步強化主角的表情、動作與情緒反差，畫面要在縮小尺寸下仍能瞬間傳達衝突與好奇心。' },
            { name: '電影預告大片感', value: '請改用電影預告片般的戲劇構圖、強烈明暗對比、輪廓光與景深，讓畫面具有大片級懸念。' },
            { name: '飽和 3D 綜藝感', value: '請改用色彩極度飽和的現代 3D 綜藝動畫風格，強化立體文字、誇張動作與高能量氣氛。' },
            { name: '極簡高對比', value: '請減少背景元素，只保留單一核心主體、大片乾淨負空間與高對比大字，讓縮圖更容易辨識。' }
        ],
        reels: [
            { name: '隨機驚喜', value: '' },
            { name: '故事節奏更強', value: '請加強 4～5 張圖卡的起承轉合與情緒推進，讓每張只保留一個清楚的視覺重點。' },
            { name: '安全區與留白優先', value: '請增加手機直式畫面的安全區與留白，讓主標、人物臉部、CTA 與 Logo 在 Reels 介面中保持清楚可見。' },
            { name: '短句極簡閱讀', value: '請把圖上文字再精簡，主標更有記憶點，重點最多三項，讓使用者能在快速滑動時立即讀懂。' },
            { name: '系列視覺一致', value: '請強化整組圖卡的配色、人物比例、字體層級與版面系統一致性，同時讓每張構圖有明確變化。' }
        ]
    };
