...
export const PRESET_TAGS = ['居久屋微醺夜', '噗噗聊聊'];
export const CUSTOM_CTA_STORAGE_KEY = 'aliang-yttb-custom-ctas';
export const CUSTOM_TAGS_STORAGE_KEY = 'aliang-yttb-custom-tags';

export const currentAbortController = null;
