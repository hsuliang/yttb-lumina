// Shared, browser-safe transcription processing. No network or Worker bindings.
...
export function processWhisperResult(result, { language, promptWords = [], replaceRules = [], audioAnalysis, isFirstChunk = false, usedMinimalInput = false }) {
...
export function formatWhisperResult(selected, audioAnalysis, isFirstChunk, retried = false) {
...
export function parseWhisperDictionary(customDict) {
    let promptWords = [];
    let replaceRules = [];
