...
目前版本：丙午．秋分．20260926**R2**

## 🌟 核心功能

本專案提供九大核心分頁功能，形成一套完整的「數位內容煉金術」工作流：
...
### 8. 🎬 YouTube 封面提示詞
從內容或爆款主題配對產生繁中主標題、副標題與固定六段結構的 16:9 繪圖提示詞；支援角色／素材、Logo、鏡頭、表情／敘事方向、標題位置、藝術風格、多版本與複製。

### 9. 📽️ Reels 分鏡提示詞
先分析文章的 Hook、問題、方法、案例與結論，再整理 4～5 張 9:16 直式圖卡；每張只保留一個核心訊息，只輸出可逐張生成的完整繪圖提示詞，並在開頭標示預計生成的張數。TAB5–8 可互相參考角色／素材、Logo 與相容的視覺風格設定。
